...
dependencies_json_path = 'vendor/mdroid/products/%s/mdroid.dependencies'
...
if __name__ == '__main__':
    ...
    if len(syncable_projects) > 0:
        ...
        if os.system('repo sync --force-sync --force-broken --quiet --no-clone-bundle --no-tags %s' % ' '.join(syncable_projects)) != 0:
